...
icoListElements.forEach(order => {
    ...
    workbook.xlsx.readFile('./faktura.xlsx')
        .then(function() {
            ...
            worksheet.getCell('C6').value = sampleData.nazev;
            worksheet.getCell('I6').value = sampleData.nazev;


            var adresaDodavatel = sampleData.sidlo.split(',');
            var adresaOdberatel = sampleData.sidlo.split(',');
            ...
            //opět mock data
            worksheet.getCell('C44').value = sampleData.nazev;
